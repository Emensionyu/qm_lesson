...
class Flypig extends React.Component{
   ...
   componentDidMount(){
       this.setState({
           taobaoId:"2833359326mxr"
       })
   }
    render(){
        const { isSignUp,taobaoId }=this.state;
        ...
        const menu = (
            ...
            const collectionmenu = (
                <Menu>
                    <Menu.Item>
                        <a target="_blank" className="menu-a" rel="noopener noreferrer" href="http://www.alipay.com/">收藏的宝贝</a>
                    </Menu.Item>
                    <Menu.Item>
                        <a target="_blank" className="menu-a" rel="noopener noreferrer" href="http://www.alipay.com/">收藏的店铺</a>
                    </Menu.Item>
                ...
                <div className={Style.header}>
                    <div className="nav-left">
                        ...
                        </div>
                        {
                            ...
                            <div className="nav-hint">Hi，{taobaoId},最近想去哪里玩？</div>
                        }
                        {
